    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow pb-20">
        ...
        <div className="container mx-auto px-4">
          ...
          {/* Популярные бренды - на главной странице выводим логотипы брендов в ряд */}
          <section className="mb-12">
            <h2 className="text-xl font-bold text-black mb-6 uppercase tracking-wide">Популярные бренды</h2>
            
            <div className="flex overflow-x-auto pb-2 gap-3 no-scrollbar">
              {/* Nike */}
              <button 
                onClick={() => { 
                  setLocation("/brand/Nike"); 
                  handleBrandChange('Nike');
                }}
          ...
          <section className="mb-8">
                ...
                <div className="mt-6 flex flex-wrap gap-2">
                  {selectedCategory && (
                    <div className="bg-gray-100 py-1 px-3 rounded-full text-sm flex items-center">
                      ...
                      <button 
                        onClick={() => setLocation(getResetPath())}
                        className="ml-2 text-black hover:text-gray-800 border-0 bg-transparent p-0"
                      >
                        <X className="h-3 w-3" />
                      </button>
                    </div>
            ...
            {(selectedCategory || selectedBrand || selectedStyle) ? (
              ...
              <div className="space-y-10">
                {/* Организованный список брендов и категорий */}
                <BrandCategoryList 
                  title="Nike" 
                  imageUrl={nikeImg}
                  onBrandClick={() => {
                  ...
                  categoryLinks={[
                    { title: "Кроссовки", onClick: () => {
                      setLocation("/category/lifestyle");
                      handleCategoryChange('lifestyle');
                    }},
                    { title: "Одежда", onClick: () => {
                      setLocation("/category/clothing");
                      handleCategoryChange('clothing');
                    }},
                    { title: "Аксессуары", onClick: () => {
                      setLocation("/category/accessories");
                ...
                <BrandCategoryList 
                  ...
                  categoryLinks={[
                    { title: "Кроссовки", onClick: () => {
                      setLocation("/category/basketball");
                      handleCategoryChange('basketball');
                    }},
                    { title: "Одежда", onClick: () => {
                      setLocation("/category/clothing");
                      handleCategoryChange('clothing');
