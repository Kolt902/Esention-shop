...
export const pl: Translation = {
  ...
  settings: {
    ...
    profileDescription: 'Zmień swoje dane osobowe',
    preferences: 'Preferencje',
    preferencesDescription: 'Dostosuj swoją aplikację',
    general: 'Ogólne',
    currency: 'Waluta',
    ...
    email: 'Email',
    phone: 'Telefon',
    orderUpdates: 'Aktualizacje zamówień',
    orderUpdatesDescription: 'Otrzymuj powiadomienia o statusie zamówień',
    promotions: 'Promocje i zniżki',
    promotionsDescription: 'Otrzymuj powiadomienia o specjalnych ofertach i zniżkach',
    newArrivals: 'Nowe produkty',
    newArrivalsDescription: 'Otrzymuj powiadomienia o nowych produktach',
    priceDrops: 'Obniżki cen',
    priceDropsDescription: 'Otrzymuj powiadomienia o obniżkach cen ulubionych produktów',
    profileUpdated: 'Profil zaktualizowany',
    profileUpdatedDescription: 'Twój profil został pomyślnie zaktualizowany',
    updateError: 'Błąd aktualizacji',
    updateErrorDescription: 'Wystąpił błąd podczas aktualizacji profilu. Spróbuj ponownie.',
  },
};
...
export const cs: Translation = {
  ...
  settings: {
    ...
    profileDescription: 'Změňte své osobní údaje',
    preferences: 'Preference',
    preferencesDescription: 'Přizpůsobte si aplikaci',
    general: 'Obecné',
    currency: 'Měna',
    selectCurrency: 'Vyberte měnu',
    lightTheme: 'Světlý',
    darkTheme: 'Tmavý',
    autoTheme: 'Automatický',
    ...
    email: 'Email',
    phone: 'Telefon',
    orderUpdates: 'Aktualizace objednávek',
    orderUpdatesDescription: 'Dostávat oznámení o stavu objednávek',
    promotions: 'Akce a slevy',
    promotionsDescription: 'Dostávat oznámení o speciálních nabídkách a slevách',
    newArrivals: 'Nové produkty',
    newArrivalsDescription: 'Dostávat oznámení o nových produktech',
    priceDrops: 'Snížení cen',
    priceDropsDescription: 'Dostávat oznámení o snížení cen oblíbených položek',
    profileUpdated: 'Profil aktualizován',
    profileUpdatedDescription: 'Váš profil byl úspěšně aktualizován',
    updateError: 'Chyba aktualizace',
    updateErrorDescription: 'Při aktualizaci profilu došlo k chybě. Zkuste to prosím znovu.',
  },
};
...
export const de: Translation = {
  ...
  settings: {
    ...
    profileDescription: 'Ändern Sie Ihre persönlichen Informationen',
    preferences: 'Einstellungen',
    preferencesDescription: 'Passen Sie die App an Ihre Bedürfnisse an',
    general: 'Allgemein',
    currency: 'Währung',
    ...
    orderUpdatesDescription: 'Benachrichtigungen über den Status Ihrer Bestellungen erhalten',
    promotions: 'Angebote und Rabatte',
    promotionsDescription: 'Benachrichtigungen über Sonderangebote und Rabatte erhalten',
    newArrivals: 'Neuheiten',
    newArrivalsDescription: 'Benachrichtigungen über neue Produkte erhalten',
    priceDrops: 'Preissenkungen',
    priceDropsDescription: 'Benachrichtigungen über Preissenkungen für Ihre Favoriten erhalten',
    profileUpdated: 'Profil aktualisiert',
    profileUpdatedDescription: 'Ihr Profil wurde erfolgreich aktualisiert',
    updateError: 'Aktualisierungsfehler',
    updateErrorDescription: 'Bei der Aktualisierung Ihres Profils ist ein Fehler aufgetreten. Bitte versuchen Sie es erneut.',
  },
};
